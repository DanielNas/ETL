...
# ===== EXECUÇÃO =====
logger.info('Inicio da extracao dos arquivos...')
...
def carregar_arquivos():
    ...
    if not os.path.exists(DIR_RAW_DATA):
        logger.error(f'Diretorio de dados nao encotrado: {DIR_RAW_DATA}')
        return dataframes
    ...
    logger.info('Processo de extracao concluido!')

    return dataframes   

def extract_files_olist():
